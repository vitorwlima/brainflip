...
- [ ] finish testing the whole lobby and online experience
  ...
  - [ ] other people can see the game settings but its not cursor pointer and not clickable (verify server-side too maybe?)
  - [ ] host can kick people
  - [ ] host can start the game (that component is only the lobby, separate that into its own comp)
