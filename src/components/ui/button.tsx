  ...
  (
    ...
    return (
      <Component
        ref={ref}
        className={cn(
          "inline-flex relative cursor-pointer items-center justify-center gap-2 rounded-full text-center font-medium tracking-wide transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-sky-500/20 disabled:pointer-events-none disabled:opacity-60 disabled:cursor-not-allowed",
